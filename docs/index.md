...
`anovapowersim` is designed to be simple and easy to use, which means it
has some limitations. It does not support:
...
`anovapowersim` is fairly limited in its goal to be simple. I recommend
checking out [`Superpower`](https://aaroncaldwell.us/Superpower/), which
handles some of the limitations above.
